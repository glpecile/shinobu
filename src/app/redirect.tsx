...
/**
 * Lands `shinobu://redirect` (Trakt's and Simkl's `?code=...&state=...`,
 * AniList's `#access_token=...`) on a real matched route instead of
 ...
 * happens in `connect-trakt-button.tsx` / `connect-anilist-button.tsx` /
