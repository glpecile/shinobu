  ...
  return (
    <View className="flex-1 bg-background items-center justify-center px-8">
      ...
      <Text className="text-xl text-foreground mb-8 text-center leading-relaxed">
        Log it once,{" "}
        <Text className="text-accent font-semibold">everywhere it belongs</Text>.
      </Text>

      <Text className="text-base text-muted text-center max-w-sm">
        Colors live in{" "}
        <Text className="font-semibold text-foreground">src/global.css</Text> as
        theme tokens — use those classes, never raw hex.
      </Text>
